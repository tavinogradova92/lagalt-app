...
export class FilterBarComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.svgPopular = this.sanitizer.bypassSecurityTrustHtml(
    ...
    this.svgNew = this.sanitizer.bypassSecurityTrustHtml(
  ...
  onIndustryChosen(): void {
    this.industryChosen.emit(parseInt(this.industryChoice.value.industry, 10));
  }
